<template>
  <el-dialog title="编辑仓库" :visible.sync="dialogVisible">
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="handleSub">修 改</el-button>
    </div>
...
export default {
  ...
  methods: {
    show(flag, item) {
      ...
      this.form = {...item}
      this.handleChangeProv(item.provId)
    },
