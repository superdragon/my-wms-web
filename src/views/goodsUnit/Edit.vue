<template>
  <el-dialog :title="'编辑' + title" :visible.sync="dialogVisible">
...
<script>
import { updateGoodsBrand } from '@/api/goodsBrand'
import { updateGoodsTaste } from "@/api/goodsTaste";
import { updateGoodsPack } from "@/api/goodsPack";
